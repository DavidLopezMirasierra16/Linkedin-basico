...
<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Usuario '. $datos_perfil->nombre_completo) }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @else
                        ...
                        <div class="mt-6 p-3 mx-auto mt-2 sm:rounded-lg" style="background-color: #f3f4f6; width:90%">
                            ...
                            <p class="text-xl mt-5 mb-2">Educación</p>
                            {{-- FORMACIÓN ACADÉMICA --}}
                            @if ($educaciones_perfil->count()==0)
                                <p>No tiene eduacion registrada</p>
                            @else
                            ...
                            @if ($experiencia_perfil->count()==0)
                                <p>No tiene experiencia registrada</p>
                            @else
                                @for ($i = 0; $i < $experiencia_perfil->count(); $i++)
                                    <div class="grid gap-2 mb-2 mt-2" style="grid-template-columns: 1fr 1fr 1fr">
                                        <div class="mt-2 flex flex-row">
                                    ...
                                    <div class="mt-2 mb-4 flex flex-row">
                            ...
                            @else
                                @for ($i = 0; $i < $habilidades_perfil->count(); $i++)
                                    <div class="grid gap-2 mb-2 mt-2" style="grid-template-columns: 1fr 1fr">
                                        <div class="mt-2 flex flex-row">
                            ...
                            @if ($proyectos_perfil->count()==0)
                                <p>No tiene proyectos registrados</p>
                            @else
